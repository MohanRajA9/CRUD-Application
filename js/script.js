...
const mainURL = "https://6560722983aba11d99d0d3f1.mockapi.io/api/v1/posts";
...
const renderMainBody = () => {
     ...
     posts.length = 0;
     posts.push(...data)
     mainBody.innerHTML = data.filter((post)=> post.isDeleted === needDeleted.checked)
        .map((post) => { 
        return `<div id="post-${post.id}" class="card border-primary m-3" style="max-width: 18rem;">
        ...
        <div class = "d-flex justify-content-around">
            ...
            <span id="likesCount">${post.likeCount}</span>
            </button>

          <button type="button" class="btn btn-outline-danger" onclick="deletePost(${post.id})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
